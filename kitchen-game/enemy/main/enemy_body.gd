...
@export var max_wall_time_until_death: float = 5.0
@onready var wall_time_until_death: float = max_wall_time_until_death
...
@export var inside_wall_check_2: ObjectDetection
